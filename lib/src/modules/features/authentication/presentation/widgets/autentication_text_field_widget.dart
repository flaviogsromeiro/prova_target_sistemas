...
class AutenticationTextFieldWidget extends StatefulWidget {
  const AutenticationTextFieldWidget({
    Key? key,
    this.prefixIcon,
    this.suffixIcon,
  ...
  @override
  State<AutenticationTextFieldWidget> createState() =>
      _AutenticationTextFieldWidgetState();
}

class _AutenticationTextFieldWidgetState
    extends State<AutenticationTextFieldWidget> {
